...
(
    ...
    double x1, double x2,
    double y1, double y2,
    double *perim_p, double *x_proj_edge_p, double *y_proj_edge_p,
    double *x_overlap_p, double *y_overlap_p
)
{
...
(
    ...
    double x1, double x2,
    double y1, double y2,
    double *count_p, double *drag_p, double *centre_p
)
{
...
(
    ...
    double y1, double y2,
    double *count_p,
    symmTensor2D& vdrag, double *perim_p,
    double *x_lblk_p, double *y_lblk_p,
    double *x_centre_p, double *y_centre_p
)
{
    double  x_int[6][2], y_int[6][2]; // Coordinates of intersections between the circle and sides of the rectangle.
