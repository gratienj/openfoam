...
int main(int argc, char* argv[])
{
    ...
    printf("\n%6d blocks and %d cylinders/diagonal blocks\n", origBlocks.size(), cylinders.size());
    printf("%6d intersections amongst blocks\n", int2Blocks.size());
    printf("%6d intersections between blocks and cyl/db\n", int1Blocks.size());
    printf("%6d/3 triple intersections\n", int3Blocks.size());
    printf("Volume of obstacles read in: %.2f, volume of intersections: %.2f\n", volObstacles, volSubtract);
