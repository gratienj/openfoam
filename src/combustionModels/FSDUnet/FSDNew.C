...
void FSDUnet<ReactionThermo, ThermoType>::calculateSourceNorm()
{
    ...
    */
    ...
    /*
     * The progress variable is kept completely separate from Pc.
     *
     * Here c is a normalized product-based diagnostic:
     *
     *     c = Yproducts / Yproducts,max
     *
     * It is NOT used to redefine Pc.
     */
    ...
    (
        ...
        (
            max
            (
                products/max(YprodTotal, scalar(1e-12)),
                scalar(0)
            ),
            scalar(1)
        )
